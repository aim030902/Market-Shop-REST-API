package uz.aim.marketshop.service.bot;
...
public class MyBot extends TelegramLongPollingBot {
    ...
    private void handleMessage(Update update) {
        ...
        if (message.getText().equals("/start")) {
            ...
            sendPhoto.setPhoto(new InputFile(new File("/home/aim/Desktop/FrientProjects/Shahriyor/market-shop-monolit-master/src/main/resources/static/images/market.png")));
